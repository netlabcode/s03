...
val1 = client.get_node("ns=2;i=710")
val2 = client.get_node("ns=2;i=711")
val3 = client.get_node("ns=2;i=712")
val4 = client.get_node("ns=2;i=713")
val5 = client.get_node("ns=2;i=714")
val6 = client.get_node("ns=2;i=715")
val7 = client.get_node("ns=2;i=716")
