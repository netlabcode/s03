...
val1 = client.get_node("ns=2;i=704")
val2 = client.get_node("ns=2;i=705")
val3 = client.get_node("ns=2;i=706")
val4 = client.get_node("ns=2;i=707")
val5 = client.get_node("ns=2;i=708")
val6 = client.get_node("ns=2;i=709")
