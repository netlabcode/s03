...
val1 = client.get_node("ns=2;i=685")
val2 = client.get_node("ns=2;i=686")
val3 = client.get_node("ns=2;i=687")
val4 = client.get_node("ns=2;i=688")
val5 = client.get_node("ns=2;i=689")
val6 = client.get_node("ns=2;i=690")
