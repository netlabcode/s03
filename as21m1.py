...
val1 = client.get_node("ns=2;i=679")
val2 = client.get_node("ns=2;i=680")
val3 = client.get_node("ns=2;i=681")
val4 = client.get_node("ns=2;i=682")
val5 = client.get_node("ns=2;i=683")
val6 = client.get_node("ns=2;i=684")
