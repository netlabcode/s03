...
val1 = client.get_node("ns=2;i=125")
val2 = client.get_node("ns=2;i=126")
val3 = client.get_node("ns=2;i=127")
val4 = client.get_node("ns=2;i=128")
val5 = client.get_node("ns=2;i=129")
val6 = client.get_node("ns=2;i=130")
val7 = client.get_node("ns=2;i=131")
val8 = client.get_node("ns=2;i=132")
val9 = client.get_node("ns=2;i=133")
